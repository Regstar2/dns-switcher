...
Пока репозиторий GitHub остаётся private, анонимный production update-check через GitHub Releases недоступен. Это не влияет на ручную установку релиза пользователем, имеющим доступ к репозиторию.
...
- анонимная встроенная проверка обновлений не работает, пока release source остаётся private.
